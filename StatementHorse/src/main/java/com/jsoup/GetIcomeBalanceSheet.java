		...
		for (Element s : tdtext) {
			try {
				...
				if (s.text().trim().contains(" 歸屬於母公司業主之權益合計")) {
					Consolidated_Net_Income_Attributed_to_Stockholders_of_the_Company = new Long(
							tdtext.get(i + 1).text().replace(",", ""));
...
//		balancesheetdao.insert(balancesheetvo);
		...
		// 得到td tag的內容
		// 注意: 因為有好多個td
		// 我想要取得的是&amp;amp;amp;amp;amp;amp;amp;lt;td&amp;amp;amp;amp;amp;amp;amp;gt;樂&amp;amp;amp;amp;amp;amp;amp;lt;/td&amp;amp;amp;amp;amp;amp;amp;gt;
		// 是第2個td 所以填get(1)
